...
analysis = tune.run(
    ...
    name="tune_asha_bayes_4l_8h_bs4",
)
# python hyperparam_search.py --num_epochs 40 --batch_size 4 --layers 4 --num_heads 8 --project_dim 40 --project_name asha_bayes_4l_8h_bs4
